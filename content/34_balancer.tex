...
The section describes the components the load balancer is built of.
...
\begin{figure}[h!]
  ...
  \begin{captionbeside}[]{Load Balancer with one Task Proxy per client task.
    ...
    call.}
  \includestandalone[width=0.65\textwidth]{images/threadMapper_layout}
\end{captionbeside}
...
\begin{figure}[h]
  ...
  balancer.}
  \includegraphics[width=0.65\textwidth]{images/statusvortrag/arch_interval_cycle}
  \end{captionbeside}
