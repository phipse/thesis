...
Next to the load balancer, a task-specific proxy scheduler acts as information
source.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{images/statusvortrag/arch_interval_cycle}
