...
is present in the L3 cache as displayed in figure \ref{state:fig:inclusive}.
%
\begin{figure}[h!]
  \includegraphics[width=0.7\textwidth]{images/inclusive_caches}
  \caption{Caches of \gls{intel} Haswell generation processores are inclusive.
Each core contains 32KB D-, 32KB I-, 256KB L2, and 1.5MB L3 cache}
