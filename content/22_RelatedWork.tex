...
The review will focus on research regarding FIXME topics: \gls{smt},
...
Different approaches to load balancing on a multicore have been explored in
literature.
...
The combination of two jobs on two corresponding \gls{smt}-cores they call a
co-schedule.
...
They then use the measurements of the performance counters to create several
predictors for the future behaviour of the jobs.
% todo and, hence, the best schedule.
The best predictor in their study made a majority vote of all other predictors
to determine the best schedule.
Some of their other predictors were data cache hit rate, floating point unit
conflicts, and floating point queue conflicts.
...
% todo connection
However, measuring performance improvements due to increased symbiosis is
difficult.
...
Cryptographic Library (NaCL)\footnote{https://nacl.cr.yp.to} by Bernstein et al.,
\todo{cite}
