...
The performance counter in the target processor --- an \gls{intel} Core
...
Figure \ref{state:fig:core_layout} shows examplary the cache hierarchy of the
\gls{intel} Haswell processor.
...
physical core.
The CPU provides this information through the CPUID interface, when the
