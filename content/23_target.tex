...
namespace for references to other objects; for example the scheduler, object
...
and child can replace capabilities in its capability space without affecting
the other.
