...
\begin{comment} 
Starting with the common availability of computer systmes in the 80's, computing
and memory facilities have devloped in different speeds.
...
This effect is amplified by mutli-processor systems where even more processors
query the memory.
Multiple levels of different sized caches where introduced to hide memory
access latancies, as shown in figure \ref{intro:fig:accessLatencies}.
...
Starting with the common availability of computer systmes in the 80's,
...
Besides reducing the number waits for data from memory, the waiting time can be
...
\begin{figure}[h]
  ...
  \setcapindent*{1em}
  \begin{captionbeside}[Processor and memory performance gap 1980 - 2010.]
