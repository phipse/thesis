...
%    \draw (-1.4cm,2.0cm) -- ++(0,-4.5cm) -- ++(5.5cm,0) -- ++(0,4.5cm) -- cycle;
    \draw (-1.4cm,2.0cm) -- ++(0,-2.5cm) -- ++(5.5cm,0) -- ++(0,2.5cm) -- cycle;
  ...
  \begin{scope}[xshift=2.7cm]
    ...
    \node(1l1i)  [l1_cache_shape, above of=1l2, anchor=south east] {L1I--Cache};
    \node(1l1d)  [l1_cache_shape, above of=1l2, anchor=south west] {L1D--Cache};

    \node(1t0)	[thread_shape, above of=1l1i, anchor=south] {T 2};
    \node(1t1)	[thread_shape, above of=1l1d, anchor=south] {T 3};
