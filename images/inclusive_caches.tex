...
\begin{tikzpicture}
  ...
  \begin{scope}[yshift=2cm, xshift=2cm]
    \draw [pattern=dots] (0,0) -- (4,0) -- (4,1) -- (0,1) -- cycle;
  \end{scope}
  
  % L3 cache
  \begin{scope}
    \draw (0,-1.5) -- (8,-1.5) -- (8,1.5) -- (0,1.5) -- cycle;
    \draw [pattern=dots] (0,.5) -- (4,0.5) -- (4,0) -- (0,0) -- cycle;
    \draw [pattern=dots] (4,0) -- (8,0) -- (8,-0.5) -- (4,-0.5) -- cycle;
    \draw [pattern=north west lines] (0.5,-0.5) -- (1.5,-.5) -- (1.5,-1) --
    (.5,-1) -- cycle;
