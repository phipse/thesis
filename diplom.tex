...
\hypersetup{%
  pdftitle={thread mapping, µ-kernel, multicore CPUs},
  pdfauthor={Philipp Eppelt},
  pdfkeywords={space-sharing, scheduling, µ-kernels},
}

\input{preamble/packages.tex}
\addbibresource{./Related Work.bib}
