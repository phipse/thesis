\usepackage[backend=biber,style=alphabetic,alldates=long,maxcitenames=2]{biblatex}

\usepackage{varioref}           % nice refs
\usepackage{csquotes}
\usepackage{graphicx}           % graphics
\usepackage{caption}            % manipulate figures
...
\usepackage{setspace}
\usepackage{xfrac}
\usepackage[math-style=TeX,active-frac=small]{unicode-math}
